...
/* COMBO: filename = js/vip/all-vip-lifelong.v.07.10.js, type = application/javascript, resp = 200 */
$(function () {
    checkDomPrice();
    wxpayCode();
...
function checkDomPrice(container) {
    ...
    if (is_conpon_check == true) {
        ...
        console.log($(".voucher_discount").val());
...
//统计页面到达
$.post(Url.record_pv_uv_ip, {uv_id: Param.uv_id, model_type: 9999, uid: Param.uid},
    function () {
...
function checkDomPrice() {
    ...
    var discount = parseInt($(".conpon_discount option[value=" + conpon_discount_val + "]").attr('data-id'));
