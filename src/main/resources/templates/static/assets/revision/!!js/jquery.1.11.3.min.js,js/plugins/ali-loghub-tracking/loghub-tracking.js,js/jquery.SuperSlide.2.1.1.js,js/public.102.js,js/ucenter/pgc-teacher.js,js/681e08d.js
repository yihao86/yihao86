...
/* COMBO: filename = static/ucenter/pgc-teacher.static, type = application/javascript, resp = 200 */
            ...
            if(0 === response.error){
                ...
                if(0 !== response.count){
                    $.each(response.list, function (k, v) {
                        html += '<img src="' + v.avator + '" >';
                    });


                    html += '… '+ response.count +'粉丝';
...
$(function () {
    scrollFloor({
        floorClass : '.scroll-floor',       //楼层盒子class;
        navClass : '.left-nav a',           //导航盒子class;
