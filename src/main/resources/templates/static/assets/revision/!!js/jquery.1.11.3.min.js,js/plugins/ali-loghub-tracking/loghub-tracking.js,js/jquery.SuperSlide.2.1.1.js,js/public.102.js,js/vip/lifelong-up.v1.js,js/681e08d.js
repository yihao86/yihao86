...
/* COMBO: filename = static/vip/lifelong-up.v1.static, type = application/javascript, resp = 200 */
/**
 * Created by houjihao on 2018/7/9.
 */
$(function () {
    //给页面的到达次数+ 1
...
//按钮点击处理
function statistics_button_click($button_type) {
    $.get(Url.button_click_url, {type: $button_type},
        function () {
...
//统计页面到达
$.post(Url.record_pv_uv_ip, {uv_id: Param.uv_id, model_type: 13, uid: Param.uid},
    function () {}
);
