...
/* COMBO: filename = static/app-preach/app.static, type = application/javascript, resp = 200 */
(function (window) {
    var defaults = {
        floorClass: '.select',
        navClass: '.select',
    ...
    function scrollActive(_list, newOptions) {
        ...
        $.each(data, function (i, item) {
            if (nowScrollTop > item.$activeTop) {
                _list.eq(i).addClass(newOptions.activeClass)
            }
        })
    }
    ...
    var scroll_floor = window.scrollFloor = function (options) {
        ...
        navList = $body.find(newOptions.floorClass);
