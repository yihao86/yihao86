window._bd_share_main ? window._bd_share_is_recently_loaded = !0 : (window._bd_share_is_recently_loaded = !1, window._bd_share_main = {
    version: "2.0",
    jscfg: {domain: {staticUrl: "https://static/assets/revision/static/"}}
    ...
    function s(e, t) {
        ...
        this.svnMod || (this.svnMod = this.path.split("/static/")[0].substr(1)), this.type = "static", this.getKey = function () {
    ...
    e.each = n, s.currentPath = "", s.loadedPaths = {}, s.loadingPaths = {}, s.cache = {}, s.paths = {}, s.handlers = [], s.moduleFileMap = {}, s.requiredPaths = {}, s.lazyLoadPaths = {}, s.services = {}, s.isPathsLoaded = function (e) {
        ...
        e.search(":") < 0 && (t || (t = d, s.currentPath && (t = s.currentPath.split("/static/")[0].substr(1))), e = t + ":" + e);
        ...
        if ("." === t.charAt(0)) {
            ...
            return n + "/" + t + "/" + t.substr(t.lastIndexOf("/") + 1) + ".static"
        }
        var a, r, o, c, _, l;
        if (t.search(":") >= 0) {
            var h = t.split(":");
        ...
        return -1 !== (o = t.indexOf("/")) && (r = t.slice(0, o), c = t.lastIndexOf("/"), _ = t.slice(c + 1)), r && r in s.paths && (t = t.slice(o + 1)), l = f + a + "/static/" + t + ".static"
    }, s.get = function (e, t) {
        ...
        load: function () {
            ...
            this.type = a ? "css" : "static";
            var r = "/" + this.type + "/" + s.moduleFileMap[t][this.name];
            if (n += e._useConfig && s.moduleFileMap[t][this.name] ? this.type + "/" + s.moduleFileMap[t][this.name] : this.type + "/" + this.name + (a ? "" : ".static"), e._firstScreenCSS.indexOf(this.name) > 0 || e._useConfig && r == e._firstScreenJS) i._loaded = !0, i.ready(); else {
    ...
    e._setMod = function (e) {
        ...
        if ("object" == typeof t) n(t, function (t, n) {
            ...
            var a = l;
            "string" == typeof i && (i = [i]), t = 1 == t.indexOf("static/") ? t.substr(4) : t, t = 1 == t.indexOf("css/") ? t.substr(5) : t;
    ...
    window._bd_share_main.F._setMod("api"), window._bd_share_main.F._fileMap({
        "/js/share.js?v=da893e3e.js": ["conf/define", "base/fis", "base/tangrammin", "base/class.static", "conf/define.static", "conf/const.static", "config", "share/api_base.static", "view/view_base.static", "start/router.static", "component/comm_tools.static", "trans/trans.static"],
