...
/* COMBO: filename = js/vip/all-vip-info.8.8.js, type = application/javascript, resp = 200 */
/**
 * Created by Mr.D on 2017/6/28.
 */
$(function () {
    //给页面的到达次数+ 1
...
//统计页面到达
$.post(Url.record_pv_uv_ip, {uv_id: Param.uv_id, model_type: 11, uid: Param.uid},
    function () {}
);
