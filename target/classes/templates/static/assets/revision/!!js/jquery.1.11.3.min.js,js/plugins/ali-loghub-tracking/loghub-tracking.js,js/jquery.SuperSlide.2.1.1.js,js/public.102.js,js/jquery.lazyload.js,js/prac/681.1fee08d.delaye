...
/* COMBO: filename = js/practice/index.v.06.04.js, type = application/javascript, resp = 200 */
/*
*   每周一练
**/
$(function() {
    ...
    var $winBtn = $('#win-box'),
        $allBtn = $('#all-box'),
        $allBox = $('.all-zp .work-list-new'),
        $winBox = $('.all-zp .prize-list'),
        $banBox = $('.all-zp .check-box'),
    ...
    if(Param.isNew == '0' && Param.toRank == '0'){
        // changePag($winBtn, $thSly, $winBox, $allBox, $allBtn, $banBox, $allPagesBox, $prizePagesBox);
    ...
    **/
    //点赞
    $('#js-detail-priase').on('click', function () {
        ...
        if(1 == status){
            $.post(Url.detailUrl, {
                ...
                if (0 == b.isError) {
                    ...
                    $("#js-detail-priase #number").html(b.number);
    ...
    $('#cared-none').on('click', function () {
        ...
        var _this = $(this);
        var span = $(".follow-num span");
        $.ajax({
            url: Url.teacherFollow,
            data: {
                "_csrf-frontend": $('meta[name="csrf-token"]').attr("content"), "UserFlowerTeacherForm[tid]": $(this).attr('data-id'),
...
//                    console.log(res.number);
    ...
    $(".practice-home-go-detail").on('click', function () {
        ...
        window.open ( Url.goDetailUrl + '/' + $id + '.html' );
    });
    ...
    $("#practice-delete-work").on('click', function () {
        ...
        $model.find("#js-delete-id").val(id);
    });
    ...
    $("#practice-delete-work-model #delete-work-confirm").on('click', function () {
        $.ajax({
            ...
            data: {"_csrf-frontend": $('meta[name="csrf-token"]').attr("content"), work_id:$("#practice-delete-work-model #js-delete-id").val()},
            type: 'POST',
            dataType: 'JSON',
            success: function (res) {
    ...
    $(".details-body .details-selfinfo .share-tip").on('click', function () {
        $(this).addClass('hide');
    })

    // 排序标签定位
    if (Param.hasOrder !== '') {
        if (typeof $('.all-zp') != 'undefined' && $('.all-zp').length >= 1) {
            var $height = $('.all-zp').position().top;
